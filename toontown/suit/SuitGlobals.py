...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['flunky', 'glasses'], '', 4.88),
                  ...
                  # Experi
                  'cc': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  'tm': (3.75 / bSize, SuitDNA.experiPolyColor, ['telemarketer'], '', 5.24),
                  'nd': (4.35 / aSize, SuitDNA.experiPolyColor, ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'gh': (4.75 / cSize, SuitDNA.experiPolyColor, ['gladhander'], '', 6.4),
                  'ms': (4.75 / bSize, SuitDNA.experiPolyColor, ['movershaker'], '', 6.7),
                  'tf': (5.25 / aSize, SuitDNA.experiPolyColor, ['twoface'], '', 6.95),
                  'm': (5.75 / aSize, SuitDNA.experiPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  'mh': (7.0 / aSize, SuitDNA.experiPolyColor, ['yesman'], '', 8.95),
                  # Virus
                  'cc': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  'tm': (3.75 / bSize, SuitDNA.virusPolyColor, ['telemarketer'], '', 5.24),
                  'nd': (4.35 / aSize, SuitDNA.virusPolyColor, ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'gh': (4.75 / cSize, SuitDNA.virusPolyColor, ['gladhander'], '', 6.4),
                  'ms': (4.75 / bSize, SuitDNA.virusPolyColor, ['movershaker'], '', 6.7),
                  'tf': (5.25 / aSize, SuitDNA.virusPolyColor, ['twoface'], '', 6.95),
                  'm': (5.75 / aSize, SuitDNA.virusPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  'mh': (7.0 / aSize, SuitDNA.virusPolyColor, ['yesman'], '', 8.95),
                  }
