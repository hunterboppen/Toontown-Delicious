...
suitProperties = {'f': (4.0 / cSize, SuitDNA.corpPolyColor, ['flunky', 'glasses'], '', 4.88),
                  ...
                  # Food
                  'sc': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  'cct': (3.75 / bSize, SuitDNA.foodPolyColor, ['telemarketer'], '', 5.24),
                  'icc': (4.35 / aSize, SuitDNA.foodPolyColor, ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'ts': (4.75 / cSize, SuitDNA.foodPolyColor, ['gladhander'], '', 6.4),
                  'ps': (4.75 / bSize, SuitDNA.foodPolyColor, ['movershaker'], '', 6.7),
                  'tf': (5.25 / aSize, SuitDNA.foodPolyColor, ['twoface'], '', 6.95),
                  'bk': (5.75 / aSize, SuitDNA.foodPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  'tst': (7.0 / aSize, SuitDNA.foodPolyColor, ['yesman'], '', 8.95),
                  # Miner
                  'j': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  'd': (3.75 / bSize, SuitDNA.minerPolyColor, ['telemarketer'], '', 5.24),
                  'b': (4.35 / aSize, SuitDNA.minerPolyColor, ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'c': (4.75 / cSize, SuitDNA.minerPolyColor, ['gladhander'], '', 6.4),
                  'gl': (4.75 / bSize, SuitDNA.minerPolyColor, ['movershaker'], '', 6.7),
                  'me': (5.25 / aSize, SuitDNA.minerPolyColor, ['twoface'], '', 6.95),
                  'mt': (5.75 / aSize, SuitDNA.minerPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  'mf': (7.0 / aSize, SuitDNA.minerPolyColor, ['yesman'], '', 8.95),
                  # Experi
                  'td': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  'ti': (3.75 / bSize, SuitDNA.experiPolyColor, ['telemarketer'], '', 5.24),
                  'mu': (4.35 / aSize, SuitDNA.experiPolyColor, ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'es': (4.75 / cSize, SuitDNA.experiPolyColor, ['gladhander'], '', 6.4),
                  'cu': (4.75 / bSize, SuitDNA.experiPolyColor, ['movershaker'], '', 6.7),
                  'lr': (5.25 / aSize, SuitDNA.experiPolyColor, ['twoface'], '', 6.95),
                  'alh': (5.75 / aSize, SuitDNA.experiPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  'hls': (7.0 / aSize, SuitDNA.experiPolyColor, ['yesman'], '', 8.95),
                  # Virus
                  'n': (3.5 / cSize, VBase4(0.55, 0.65, 1.0, 1.0), ['coldcaller'], '', 4.63),
                  's': (3.75 / bSize, SuitDNA.virusPolyColor, ['telemarketer'], '', 5.24),
                  'eh': (4.35 / aSize, SuitDNA.virusPolyColor, ['numbercruncher'], 'name-dropper.jpg', 5.98),
                  'ch': (4.75 / cSize, SuitDNA.virusPolyColor, ['gladhander'], '', 6.4),
                  'bd': (4.75 / bSize, SuitDNA.virusPolyColor, ['movershaker'], '', 6.7),
                  'dd': (5.25 / aSize, SuitDNA.virusPolyColor, ['twoface'], '', 6.95),
                  'ah': (5.75 / aSize, SuitDNA.virusPolyColor, ['twoface'], 'mingler.jpg', 7.61),
                  'mah': (7.0 / aSize, SuitDNA.virusPolyColor, ['yesman'], '', 8.95),
                  }
