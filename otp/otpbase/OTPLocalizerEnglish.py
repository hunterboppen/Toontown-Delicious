...
lTheBrrrgh = 'Cold Minnies Melodyland'
lDaisyGardens = 'gARDEN Minnies Melodyland'
lDonaldsDock = "Dock Minnies Melodyland"
lDonaldsDreamland = "wake up Minnies Melodyland"
lMinniesMelodyland = "Minnies Melodyland"
lToontownCentral = 'Minnies Melodyland'
lGoofySpeedway = 'Speedy Minnies Melodyland'
lOutdoorZone = "Chip 'n Dale's Minnies Melodyland"
lGolfZone = "Chip 'n Dale's Minnies Melodyland MiniGolf"
lCancel = 'Cancel'
lClose = 'Close'
lOK = 'OK'
lNext = 'Next'
...
CRBootedReasons = {100: 'You have been disconnected because someone else just logged in using your account on another computer.',
 ...
 105: 'Toontown Delicious is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.\n\nFor more information, please visit the Toontown Delicious website.',
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Toontown Delicious Support if the problem persists.',
